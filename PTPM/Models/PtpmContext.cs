...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=DESKTOP-QRII27H;Database=PTPM;Trusted_Connection=true;TrustServerCertificate=Yes;");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.CustomerId).HasName("PK_tb_Customers");
        ...
        modelBuilder.Entity<Order>(entity =>
        {
            ...
            entity.HasOne(d => d.TransactStatus).WithMany(p => p.Orders)
                ...
                .HasConstraintName("FK_Orders_TrangThai");
        });

        modelBuilder.Entity<OrderDetaill>(entity =>
        {
            ...
            entity.HasOne(d => d.Order).WithMany(p => p.OrderDetaills)
                .HasForeignKey(d => d.OrderId)
                .HasConstraintName("FK_OrderDetaills_Orders");
        });
        ...
        {
            entity.HasKey(e => e.TransactStatusId).HasName("PK_TrangThai");
